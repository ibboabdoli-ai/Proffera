...
export const MAX_WRITABLE_WORKERS = 2;
...
function isTrustedWritableWorkerPr(pr) {
  return (
    pr.base_ref === "main" &&
    pr.head_ref.startsWith("work/proffera-") &&
    pr.head_repo === EXPECTED_REPOSITORY &&
    pr.author === TRUSTED_SUPERVISOR_ACTOR &&
    pr.body.includes(TASK_PACKET_MARKER)
  );
}
