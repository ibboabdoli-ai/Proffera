...
3. Keep AI-review routing fail closed: low-risk PRs avoid unnecessary review, medium-risk non-sensitive PRs may use bounded Codex fallback only after CodeRabbit availability failure, and sensitive/high-risk PRs require an acceptable current-head CodeRabbit decision.
