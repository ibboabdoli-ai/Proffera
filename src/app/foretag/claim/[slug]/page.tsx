              ...
              {challengeActive ? (
                ...
                <form action="/api/public-directory/claim-email/send" method="post" className="rounded-2xl border border-[#bfd4ef] bg-[#f6f9fd] p-5">
                  ...
                  <div className="mt-5 grid gap-4 sm:grid-cols-2">
                    <label className="text-sm font-bold text-[#334139]">{text.name}<input name="claimantName" required minLength={2} maxLength={100} defaultValue={session.user.name ?? ""} autoComplete="name" className="mt-2 min-h-11 w-full rounded-xl border border-[#bdc9d8] bg-white px-3 text-base sm:text-sm outline-none focus:ring-2 focus:ring-[#1469d8]/20" /></label>
                    <label className="text-sm font-bold text-[#334139]">{text.role}<input name="role" required minLength={2} maxLength={80} placeholder={text.rolePlaceholder} className="mt-2 min-h-11 w-full rounded-xl border border-[#bdc9d8] bg-white px-3 text-base sm:text-sm outline-none focus:ring-2 focus:ring-[#1469d8]/20" /></label>
                    <label className="text-sm font-bold text-[#334139]">{text.businessEmail}<input name="businessEmail" type="email" required maxLength={254} autoComplete="email" placeholder="name@company.se" className="mt-2 min-h-11 w-full rounded-xl border border-[#bdc9d8] bg-white px-3 text-base sm:text-sm outline-none focus:ring-2 focus:ring-[#1469d8]/20" /></label>
                    <label className="text-sm font-bold text-[#334139]">{text.phone} <span className="font-normal text-[#778078]">{text.optional}</span><input name="phone" type="tel" maxLength={40} autoComplete="tel" className="mt-2 min-h-11 w-full rounded-xl border border-[#bdc9d8] bg-white px-3 text-base sm:text-sm outline-none focus:ring-2 focus:ring-[#1469d8]/20" /></label>
                  </div>
