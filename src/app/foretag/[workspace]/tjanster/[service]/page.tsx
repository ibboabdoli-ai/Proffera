          ...
          <div className="grid gap-0 lg:grid-cols-[1.2fr_.8fr]">
            <div className="p-7 sm:p-10">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                {canContact ? <PublicBusinessTrackedLink workspaceId={business.id} serviceId={item.id} eventKey="contact_clicked" href="#kontaktforfragan" className="inline-flex min-h-12 items-center justify-center rounded-xl border border-black/15 px-5 font-black"><Mail className="mr-2 h-4 w-4" /> Kontakta</PublicBusinessTrackedLink> : null}
              </div>
            </div>
