...
const HOMEPAGE_LOCATION_REVALIDATE_SECONDS = 30 * 60;
...
const readCachedPublishedDirectoryLocationSuggestions = unstable_cache(
  ...
  ["public-home-location-suggestions-v1"],
  { revalidate: HOMEPAGE_LOCATION_REVALIDATE_SECONDS },
);
