...
export const directoryCopy = {
  sv: {
    ...
    publishedOnly: "Publicerade och aktiva Proffera-företag · max 30", officialData: "Officiella företagsdata", away: (km: number) => `${km.toFixed(1)} km bort`,
    serviceAreaMatch: "Din position ligger inom företagets bekräftade serviceområde.",
    profferaBusiness: "Aktivt Proffera-företag", viewProfile: "Visa profil", viewCompany: "Se företag", viewService: "Se tjänst",
    book: "Boka", requestQuote: "Begär offert", contact: "Kontakta",
    empty: "Inga publicerade företag hittades för den här sökningen ännu.",
  ...
  en: {
    ...
    publishedOnly: "Published and active Proffera businesses · max 30", officialData: "Official company data", away: (km: number) => `${km.toFixed(1)} km away`,
    serviceAreaMatch: "Your position is within the company's confirmed service area.",
    profferaBusiness: "Active Proffera business", viewProfile: "View profile", viewCompany: "View company", viewService: "View service",
    book: "Book", requestQuote: "Request quote", contact: "Contact",
    empty: "No published companies were found for this search yet.",
