...
export const directoryProfileCopy = {
  sv: {
    ...
    updated: "Senast uppdaterad", synced: "kontrollerad vid senaste synk", fallbackCategory: "Tjänsteföretag",
  },
  en: {
    ...
    updated: "Last updated", synced: "checked during the latest sync", fallbackCategory: "Service business",
  },
