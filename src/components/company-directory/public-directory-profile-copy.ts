...
export const directoryProfileCopy = {
  sv: {
    ...
    phone: "Telefon", email: "E-post", website: "Webbplats", locked: "Låst", unavailable: "Saknas",
    lockedContactHint: "Kontaktuppgifterna visas när företaget har en aktiv Proffera-plan.",
  ...
  en: {
    ...
    phone: "Phone", email: "Email", website: "Website", locked: "Locked", unavailable: "Not available",
    lockedContactHint: "Contact details are shown when the business has an active Proffera plan.",
