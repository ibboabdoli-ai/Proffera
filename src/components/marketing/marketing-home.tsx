...
const copy: Record<PublicLocale, HomeCopy> = {
  sv: {
    ...
    pricingLead: "Alla planer är byggda runt samma kundflöde. Priser visas inklusive moms för svenska kunder och Stripe Checkout visar alltid den slutliga betalningen.",
    ...
    faqs: [
      ...
      { question: "Kan jag använda egen domän?", answer: "Egen domän finns för Enterprise-upplägg. Befintliga bokningsdomäner fortsätter vara bokningsfokuserade tills företaget själv väljer företagssidan som startsida." },
    ],
  ...
  en: {
    ...
    pricingLead: "Every plan is built around the same customer flow. Stripe Checkout always shows the final charge, including tax where applicable.",
    ...
    plans: [
      ...
      { name: "Professional", price: getCheckoutPlanPriceLabel("professional", "SEK", "en"), description: "For businesses that want to show services online and run more of the customer journey in Proffera.", features: ["Everything in Starter", "Business page", "Quotes", "Gallery and verified reviews", "Analytics", "Multiple staff"], cta: "Start free", href: "/en/create-account?plan=professional" },
