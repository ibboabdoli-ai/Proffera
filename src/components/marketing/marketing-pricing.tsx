...
const copy = {
  sv: {
    ...
    intro: "Starter samlar kärnan för bokning, leads och kundhantering. Professional lägger till företagssida, offerter, omdömen, galleri och analys. Business är för upplägg som behöver egen domän och en mer anpassad lösning.",
    ...
    plans: [
      ...
      },
      {
        ...
        features: ["Allt i Professional", "Egen domän", "Business-funktioner efter behov", "Anpassad uppsättning"],
        cta: "Kontakta oss",
        href: "/kontakt",
      },
    ],
    ...
    faqs: [
      ...
      { q: "Varför har Business inget fast pris?", a: "Business är avsett för upplägg som behöver egen domän eller andra mer avancerade behov och prissätts därför efter upplägget." },
    ],
  },
  en: {
    eyebrow: "Pricing",
    title: "Start with the core and unlock more of the customer flow when you need it",
    intro: "Starter covers the core for booking, leads and customer management. Professional adds the business page, quotes, reviews, gallery and analytics. Business is for setups that need a custom domain and a more tailored solution.",
    ...
    plans: [
      ...
      },
      {
        ...
        features: ["Everything in Professional", "Custom domain", "Business capabilities as needed", "Tailored setup"],
        cta: "Contact us",
        href: "/en/contact",
      },
    ],
    ...
    faqs: [
      ...
      { q: "Why does Business not have a fixed price?", a: "Business is intended for setups that need a custom domain or other more advanced requirements, so pricing depends on the setup." },
    ],
  },
} as const;
