...
export function JuliusBookingDemo({ bookingContent, live = false }: JuliusBookingDemoProps) {
  ...
  return (
    <>
      {live ? <>
        <title>Julius Salong – Boka tid</title>
        <meta name="application-name" content="Julius Salong" />
        <meta name="theme-color" content="#173e2b" />
        <meta name="mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="Julius Salong" />
        <link rel="manifest" href="/boka/julius-salong/manifest.webmanifest" />
        <link rel="apple-touch-icon" href="/brand/julius-salong-app-icon.svg" />
      </> : null}
