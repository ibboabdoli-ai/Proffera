        ...
        <details ref={menuRef} className="relative lg:hidden">
          ...
          <div className="absolute right-0 top-[3.25rem] w-72 rounded-2xl border border-[#dfe5dd] bg-white p-3 shadow-xl shadow-[#102a1c]/10">
            <nav className="grid gap-1" aria-label="Huvudmeny mobil">
              ...
              <Link href="/logga-in" onClick={closeMenu} className="rounded-xl px-3 py-2.5 text-sm font-semibold text-[#17452f] transition hover:bg-[#f2f6f2]">
                Logga in
              </Link>
              <ButtonLink href="/demo" onClick={closeMenu} className="mt-2 w-full">
