...
export function Header({ locale }: HeaderProps) {
  ...
  return (
    <header className={marketplaceContext
      ...
      : "sticky top-0 z-40 border-b border-[#dfe5dd]/80 bg-white/90 backdrop-blur-xl"
    }>
      <div
      ...
      >
        ...
        <nav
          className={`hidden items-center gap-7 text-sm font-semibold lg:flex ${marketplaceContext ? "text-[#22324c]" : "text-[#526057]"}`}
          ...
          {navigation.map((item) => (
            <Link
              ...
              className={marketplaceContext
                ...
                : "transition hover:text-[#17452f] focus:outline-none focus-visible:text-[#17452f]"
              }
            >
              {item.label}
            </Link>
        ...
        <div className="hidden items-center gap-3 sm:flex">
          {alternateLocalePath ? (
            <a
              ...
              className={marketplaceContext
                ...
                : "rounded-lg border border-[#cfd8cf] px-2.5 py-2 text-xs font-bold tracking-wide text-[#17452f] transition hover:bg-[#eef5ef] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#17452f]"
              }
            >
          ...
          <Link
            ...
            className={marketplaceContext
              ...
              : "text-sm font-semibold text-[#17452f] transition hover:text-[#0e2e1e] focus:outline-none focus-visible:text-[#0e2e1e]"
            }
          >
            {copy.loginLabel}
          </Link>
        ...
        <details ref={menuRef} className="relative lg:hidden">
          <summary className={marketplaceContext
            ...
            : "flex h-11 cursor-pointer list-none items-center rounded-xl border border-[#d7ded5] px-4 text-sm font-semibold text-[#17452f] marker:hidden transition hover:bg-[#eef5ef] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#17452f]"
          }>
            {copy.menuLabel}
          </summary>
          ...
          <div className={marketplaceContext
            ...
            : "absolute right-0 top-[3.25rem] w-72 rounded-2xl border border-[#dfe5dd] bg-white p-3 shadow-xl shadow-[#102a1c]/10"
          }>
            <nav className="grid gap-1" aria-label={copy.mobileNavigationLabel}>
              {navigation.map((item) => (
                <Link
                  ...
                  className={marketplaceContext
                    ...
                    : "rounded-xl px-3 py-2.5 text-sm font-medium text-[#344139] transition hover:bg-[#f2f6f2] hover:text-[#17452f]"
                  }
                >
                  {item.label}
                </Link>
              ...
              <Link
                ...
                className={marketplaceContext
                  ...
                  : "rounded-xl px-3 py-2.5 text-sm font-semibold text-[#17452f] transition hover:bg-[#f2f6f2]"
                }
              >
                {copy.loginLabel}
              </Link>
