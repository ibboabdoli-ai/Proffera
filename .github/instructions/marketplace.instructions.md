---
applyTo: "src/lib/marketplace-*.ts,src/lib/*quote*.ts,src/features/matching/**,src/app/api/marketplace/**,src/app/**/offert/**,src/app/**/quote/**,.github/workflows/marketplace-auto-worker.yml,tests/marketplace-*,tests/*quote*"
---
